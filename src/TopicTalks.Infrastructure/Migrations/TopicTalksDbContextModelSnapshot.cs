...
{
    [DbContext(typeof(TopicTalksDbContext))]
    partial class TopicTalksDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("TopicTalks.Domain.Entities.Answer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AnswerId = 1L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8351),
                        ...
                        {
                            AnswerId = 2L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8354),
                        ...
                        {
                            AnswerId = 3L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8356),
                        ...
                        {
                            AnswerId = 4L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8357),
                        ...
                        {
                            AnswerId = 5L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8359),
            ...
            modelBuilder.Entity("TopicTalks.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            QuestionId = 1L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8185),
                        ...
                        {
                            QuestionId = 2L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8188),
                        ...
                        {
                            QuestionId = 3L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8189),
                        ...
                        {
                            QuestionId = 4L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8191),
                        ...
                        {
                            QuestionId = 5L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8192),
                        ...
                        {
                            QuestionId = 6L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8194),
            ...
            modelBuilder.Entity("TopicTalks.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8099),
                        ...
                        {
                            UserId = 2L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8112),
                            Email = "doe@email.net",
                            PasswordHash = "AQAAAAIAAYagAAAAEH4sN4yXGhfbr83UweaRK6lW4ql9PztpEKWTR6SbkhWTiX1P0mWxRTm8gJr8O3SENg==",
                            Salt = "vFsYhyBIKKEYbGH4F5rQfR2Q5bAyZ4nH2Q0Vwo3kxxM="
                        },
                        ...
                        {
                            UserId = 3L,
                            CreatedAt = new DateTime(2024, 3, 22, 19, 42, 53, 51, DateTimeKind.Local).AddTicks(8114),
                            Email = "bob@email.net",
                            PasswordHash = "AQAAAAIAAYagAAAAEH4sN4yXGhfbr83UweaRK6lW4ql9PztpEKWTR6SbkhWTiX1P0mWxRTm8gJr8O3SENg==",
                            Salt = "vFsYhyBIKKEYbGH4F5rQfR2Q5bAyZ4nH2Q0Vwo3kxxM="
                        });
